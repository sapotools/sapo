...
protected:
  ...
  public:
     ...
     *
     * @param orig the model for the new object
     */
...
public:
   ...
   * @param routine is the task routine.
   * @param params is the task parameters.
   */
   ...
   * @tparam T is the type of the task routine.
   * @tparam Ts are the type of the task parameters.
   * @param batch_id is the id of the considered batch.
   * @param routine is the task routine.
   * @param params is the task parameters.
   */
  template<typename T, typename... Ts>
