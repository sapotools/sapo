...
Ebola::Ebola() {
	...
	this->reach_sets.push_back(reach_set);
	Polyhedron *reach_set2 = new Parallelotope(set_vars,u);
	this->reach_sets.push_back(reach_set2);
	...
	poly_values ini_cond;(base_vertex,lenghts,u);
	ini_cond.base_vertex = base_vertex;
	ini_cond.lenghts = lenghts;

	this->initial_conditions.push_back(ini_cond);

	base_vertex[0] = 800.0005;
	ini_cond.base_vertex = base_vertex;
